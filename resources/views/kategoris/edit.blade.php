    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($kategori)
                ...
                <a href="{{ url('kategoris') }}" class="btn btn-sm btn-default mt2">Kembali</a>
            @else
                <form method="POST" action="{{ url('/kategoris/' . $kategori->kategori_id) }}" class="form-horizontal">
                    @csrf
        ...
        yang butuh method PUT -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('kategoris') }}">Kembali</a>
                        </div>
                    </div>
                </form>
            @endempty
