        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($data) {
                return '<div class="btn-group" role="group">'
                    . '<a href="' . route('/level/edit', $data->level_id) . '" class="btn btn-sm btn-warning">Edit</a>'
                    . '<a href="' . route('/level/hapus', $data->level_id) . '" class="btn btn-sm btn-danger">Delete</a>'
                    . '</div>';
            })
            ->setRowId('level_id');
    }
